...
constructor(private val destinationColumns: JavaBaseConstants.DestinationColumns = JavaBaseConstants.DestinationColumns.LEGACY) : CsvSheetGenerator {
    ...
    override fun getDataRow(
        ...
        return when (destinationColumns) {
            JavaBaseConstants.DestinationColumns.LEGACY -> listOf(id, formattedString, Instant.ofEpochMilli(emittedAt))
            JavaBaseConstants.DestinationColumns.V2_WITH_META -> listOf(
                id,
            ...
            JavaBaseConstants.DestinationColumns.V2_WITHOUT_META -> listOf(
                id,
                Instant.ofEpochMilli(emittedAt),
                "",
                formattedString
