...
class ChanneledStream(SlackStream, ABC):
    ...
    def __init__(self, channel_filter: List[str] = [], join_channels: bool = False, read_private_channels: bool = True, **kwargs):
        self.channel_filter = channel_filter
        self.join_channels = join_channels
        self.read_private_channels = read_private_channels
        self.kwargs = kwargs
        super().__init__(**kwargs)
...
class SourceSlack(AbstractSource):
    ...
    def streams(self, config: Mapping[str, Any]) -> List[Stream]:
        ...
        read_private_channels = config.get("read_private_channels")

        channels = Channels(authenticator=authenticator, join_channels=should_join_to_channels, channel_filter=channel_filter, read_private_channels=read_private_channels)
        streams = [
            channels,
